                                    ...
                                    foreach ($fask as $fk) : {
                                       ...
                                       <tr class="text-center">
                                           ...
                                           <td>
                                               ...
                                               <a href="<?= base_url('admin/deletefask/' . $fk['id_fasilitas']) ?>" class="btn btn-danger tombol-hapus">Hapus</a>
                                           </td>
                                       </tr>
                                   <?php endforeach ?>
                               </tbody>
       ...
       <div class="modal-dialog modal-dialog-centered" role="document">
           <div class="modal-content">
               ...
               <div class="modal-body">
                   <form action="<?= base_url('admin/createfask') ?>" method="post">
       ...
       <div class="modal fade" tabindex="-1" role="dialog" id="update<?= $fk['id_fasilitas'] ?>">
           <div class="modal-dialog modal-dialog-centered" role="document">
               <div class="modal-content">
                   ...
                   <div class="modal-body">
                       <form action="<?= base_url('admin/updatefask/' . $fk['id_fasilitas']) ?>" method="post">
                           <div class="form-group">
                               <label>Tipe Kamar</label>
